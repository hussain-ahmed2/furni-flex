...
export default function Header() {
	...
	return (
		<header className="border-b border-gray-200">
			<nav className="max-w-7xl mx-auto px-5 min-h-20 flex md:grid grid-cols-3 justify-between items-center">
				...
				<button
					...
					className="md:hidden border border-neutral-200 p-2 rounded hover:bg-neutral-200 transition duration-300"
				>
					<Menu size={32} />
				</button>

				<div
					className={`md:col-span-2 flex justify-between max-md:absolute top-20 left-0 max-md:w-full max-md:flex-col gap-2.5 max-md:bg-neutral-50 max-md:border-b max-md:border-neutral-300 max-md:z-10 transition origin-right duration-300 ${
						isOpen ? "" : "max-md:scale-x-0"
					}`}
				>
					<div className="flex gap-2.5 font-medium max-md:flex-col">
						<Link
							href="/"
					...
					<div className="flex md:items-center gap-2.5 md:gap-6 max-md:flex-col">
						<Link onClick={handleClose} href="/cart">
							<div className="max-md:px-5 max-md:py-2">
								<svg
									width="33"
									height="34"
									viewBox="0 0 33 34"
